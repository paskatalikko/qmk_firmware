...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_tkl_iso_wkl(
    ...
    KC_LSFT, KC_NUBS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,   KC_SLSH,    KC_RSFT,    MO(_CN),               KC_UP,
    KC_LCTL, KC_LALT,                   KC_SPC,                                      KC_RALT,           KC_RGUI,                              KC_LEFT, KC_DOWN, KC_RGHT),

  [_FUNCTION] = LAYOUT_tkl_iso_wkl(
    ...
    MO(_CN), SYSTEMOUT, XXXXXXX, XXXXXXX, RESTARTSERVER1, XXXXXXX, XXXXXXX, KC_PGUP, KC_UP,   KC_PGDN,  KC_PSCR, XXXXXXX, XXXXXXX,            KC_MPLY, KC_MNXT, KC_VOLD,
    _______, XXXXXXX,   SOLRLOG, REXPATH, XXXXXXX,        XXXXXXX, KC_HOME, KC_LEFT, KC_DOWN, KC_RIGHT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    _______, XXXXXXX,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,        XXXXXXX, KC_END,  XXXXXXX, KC_INS,   XXXXXXX, XXXXXXX, KC_RSFT, XXXXXXX,            XXXXXXX, 
    XXXXXXX, XXXXXXX,                     XXXXXXX,                                   XXXXXXX,           XXXXXXX,                              XXXXXXX, XXXXXXX, XXXXXXX ),

  [_CONTROL] = LAYOUT_tkl_iso_wkl(
    ...
    KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,    KC_F10,  KC_F11,  KC_F12,  KC_DEL,             XXXXXXX, XXXXXXX, KC_VOLU,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RESET,   XXXXXXX, XXXXXXX, KC_PGUP, KC_UP,   KC_PGDN,  KC_PSCR, XXXXXXX, XXXXXXX,                     KC_MPLY, KC_MNXT, KC_VOLD,
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_HOME, KC_LEFT, KC_DOWN, KC_RIGHT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_END,  XXXXXXX, KC_INS,   XXXXXXX, XXXXXXX, KC_RSFT, XXXXXXX,                     XXXXXXX,
    XXXXXXX,          XXXXXXX,                            XXXXXXX,                                      XXXXXXX,          XXXXXXX,            XXXXXXX, XXXXXXX, XXXXXXX ),
